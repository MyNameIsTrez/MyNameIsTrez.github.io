...
function generateColors(colorCount) {
	// These 8 colors fill the corners of an RGB cube,
	// preventing a dithering algorithm from getting "stuck" on a single color
	colors = [
		[0, 0, 0],
		[0, 0, 255],
		[0, 255, 0],
	...
	if (smallestDiff > largestDiff) {
		...
		if (debugText) {
			...
			text("colors: " + colors.length, 7, 50);
