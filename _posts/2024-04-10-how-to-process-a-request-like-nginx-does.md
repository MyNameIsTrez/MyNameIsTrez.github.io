...
So if you're trying to replicate nginx, I recommend reading the entire header and storing it as a map, before assigning the request to a C++ Server class instance.
