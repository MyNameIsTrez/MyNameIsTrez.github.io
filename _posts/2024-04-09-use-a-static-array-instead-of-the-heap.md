...
I had to do several takes of this recording and cut it short, as Linux its [OOM (Out Of Memory) killer](https://linux-mm.org/OOM_Killer) quickly decides it's time to kill some programs to free some RAM. It does so by even killing innocent programs, causing me to get logged out of my computer!
