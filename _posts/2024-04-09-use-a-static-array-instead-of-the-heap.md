...
This is because memory is split into pages of usually 4096 bytes, where your program doesn't actually get a page until it tries to read from or write to it.
