...
[Slow is smooth, smooth is fast](https://en.wiktionary.org/wiki/slow_is_smooth,_smooth_is_fast) is a neat phrase, but it is usually explained incompletely. People say: go slow, avoid mistakes, save time overall. That is true, but it misses why we rush in the first place.
...
So when you feel yourself rushing, ask whether the deadline is real or self-imposed. Usually it is self-imposed. _Enjoy_ the problem.
