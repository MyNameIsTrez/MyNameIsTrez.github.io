...
So when you next feel yourself rushing, ask whether the deadline is real or self-imposed. If it is self-imposed, the imagined faster version of yourself is not a standard to meet; it is a distraction from the work. Put it down and go back to the problem. And if you are in a position to set estimates or review work, ask whether you are accidentally rewarding speed over craft.
