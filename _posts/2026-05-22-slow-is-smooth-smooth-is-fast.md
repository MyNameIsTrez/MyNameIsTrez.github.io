...
[Slow is smooth, smooth is fast](https://en.wiktionary.org/wiki/slow_is_smooth,_smooth_is_fast) is a neat phrase, but it is usually explained incompletely. People say: go slow, avoid mistakes, save time overall. That is true but misses where the urge to rush comes from.
