...
What enables this clear separation between global and local allocated game memory, is the fact that grug throws an error when you reassign a global `id` inside of an <span style="color:#C3E88D">`on`</span> or <span style="color:#82AAFF">`helper`</span> function.
