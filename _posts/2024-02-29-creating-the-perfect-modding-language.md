...
The configuration language is a bespoke, cursed format that was only readable by the game's buggy parser, and required a pretty complex tokenizer and parser, compared to say JSON.
