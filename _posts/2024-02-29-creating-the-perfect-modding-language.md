...
The game developer can safely share `mod_api.json` with players as the game's mod API documentation. The optional work of writing and hosting a pretty website around this file, like a wiki, could then be left to the players.
