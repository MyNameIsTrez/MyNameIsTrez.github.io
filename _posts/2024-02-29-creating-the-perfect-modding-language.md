...
## The game can allow grug entities to edit each other their data

The game is responsible for giving every entity a map (think hash maps/Lua tables/JavaScript objects/Python dictionaries), and mods can then read from and write to each other their maps.
