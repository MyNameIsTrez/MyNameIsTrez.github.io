function calcLoad() {
  ...
  getLoad(previousNextColor, _textSize, previousSaveNumber, -16, false);
  ...
  getLoad(previousNextColor, _textSize * 2, previousSaveNumber, -5, false);

  getLoad(0, _textSize * 3, saveNumber, -1, true); // shows the currently selected save
  ...
  getLoad(previousNextColor, _textSize * 2, nextSaveNumber, 2.5, false);
